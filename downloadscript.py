...
api_key = "YOUR_API_KEY" # API key is in your account profile under API access
show_id = "YOUR_SHOW_ID" # Show ID is the last thing in your address bar for a show ex. https://dashboard.transistor.fm/shows/show_id
...
if api_response.status_code == 200:
    ...
    for episode in episodes:
        ...
        if audio_response.status_code == 200:
            ...
            print(f"API access failed: {audio_response.status_code}")
            break
